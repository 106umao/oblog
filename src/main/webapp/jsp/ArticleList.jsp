        ...
        <c:forEach var="article" items="${articleList}">
            <a href="article/articleDetails?articleId=${article.articleId}" class="list-group-item">
                ...
                <ul class="clearfix list_userbar">
                    <li style="float: left;"><img style="width: 30px;height: 30px;" src="${article.authorAvatar}" class="avatar img-circle" alt="头像"/></li>
                    <li style="float: left;"><p>${article.authorName}</p></li>
                    <li style="float: right;"><span class="glyphicon glyphicon-thumbs-up">${article.star}</span></li>
                    <li style="float: right;"><span class="glyphicon glyphicon-comment">${article.commentCount}</span></li>
                </ul>
            </a>
        </c:forEach>
    </div>
