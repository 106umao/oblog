        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="adminC/articleList" class="nav-link active">
    ...
    <table class="table">
      ...
      <c:forEach var="article" items="${articleList}">
        <tr>
          ...
          <td>${article.cover}</td>
          <td>${article.isDelete}</td>
            <td><a href="javascript:deleteObj('${article.articleId}')">删除</a></td>
        </tr>
      </c:forEach>
    </table>
  </div>
...
<script>
    ...
    function deleteObj(id) {
        $.get(
            "${basePath}adminC/deleteArticle?articleId="+id,
