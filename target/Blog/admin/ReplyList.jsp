                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="adminC/replyList" class="nav-link active">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>回复管理</p>
                                </a>
                            </li>
  ...
  <div id="table" class="container">
    <table class="table">
      ...
      <c:forEach items="${replyList}" var="reply">
        ...
        <td>${reply.fromUserId}</td>
        <td>${reply.toUserId}</td>
        <td>${reply.replyMsg}</td>
        <td>${reply.createDate}</td>
        <td>${reply.isDelete}</td>
          <td><a href="javascript:deleteObj('${reply.commentId}')">删除</a></td>
...
<script>
  ...
  function deleteObj(id) {
    $.get(
            "${basePath}adminC/deleteReply?replyId="+id,
